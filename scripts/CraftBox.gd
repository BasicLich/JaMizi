		...
		for y in '012':
			...
			if len(l) == 0:
				...
				if item.taken:
					...
					item_ids.push_back(item.tile_id())
...
# wooden stuff
	[0,1219,0,  0,1219,0,  0,1219,0]: "stick",
...
#	[0,0,0, 0,2,0, 232,0,0]: "torch",
	[0,232,0, 232,1015,232, 1219,1219,1219]: "campfire",
#	[0,0,0, 0,6,0, 0,1015,0]: "bottle",
	[0,0,0, 0,205,0, 0,1015,0]: "bricks",
	[0,0,0, 0,1306,0, 1306,1014,1306]: "furnace",
...
#	[0,0,1034, 0,232,0, 234,0,0]: "arrow",
	...
	[0,528,0, 831,1405,826, 0,1015,0]: "potion",
